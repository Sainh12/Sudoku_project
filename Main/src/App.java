...
private static void inputNumber(){
    ...
    System.out.printf ("Infome o numero que irá entrar na posição (coluna: %s, linha: %s):",col,row);
    var value = runUntilGetValidNumber(1,9);
    if (!board.changeValue(col,row,value)){
        System.out.printf ("A posição (coluna: %s, linha: %s) tem valor fixo\n",col,row);
    }
}
...
private static void clearValues()
{
    ...
    System.out.println("Você realmente tem certeza que deseja limpar seu jogo e perder todo seu jogo? (S/N)");
...
private static void finishGame()
{
    ...
    if (board.gameIsFinished()){
        System.out.println("Parabéns vc concluiu o jogo :D");
        showCurrentGame();
        board = null;
    } else if (board.hasErrors()){
        System.out.println("Seu jogo contém erros, encontre-o e ajuste-o");
    } else {
        System.out.println ("Vc preceisa preencher algum espaço");
    }
}
